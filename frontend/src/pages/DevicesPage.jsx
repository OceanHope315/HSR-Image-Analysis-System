  ...
  return (
    <div>
      ...
      <section className="panel table-panel">
        {loading ? <LoadingBlock /> : error ? <ErrorBlock message={error} onRetry={loadDevices} /> : devices.length === 0 ? <EmptyBlock title="暂无设备" description={isAdmin ? '创建第一台模拟设备以开始演示心跳。' : '尚未配置设备。'} /> : <>
